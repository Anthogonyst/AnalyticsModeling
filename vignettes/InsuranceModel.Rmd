...
saveRDS(funnyModel, paste0(here::here("data"), "/funnyModel.rds"))
```
...
saveRDS(smallerModel, paste0(here::here("data"), "/smallerModel.rds"))
```

```{r}
funnyModel = readRDS(paste0(here::here("data"), "/funnyModel.rds"))
smallerModel = readRDS(paste0(here::here("data"), "/smallerModel.rds"))
```
