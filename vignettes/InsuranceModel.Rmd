...
# Loop through each continuousc olumn in the data and create a histogram plot 
for (col in contVars) {
  plot <- ggplot(cleanData, aes({{col}})) + 
          geom_histogram()
  print(plot)
}

# Loop through each discrete or categorical var
